            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Quản trị</h3><!-- /.menu-title -->
                      ...
                      <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="category-create.php">Tạo danh mục</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="category-read.php">Xem các danh mục</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="shop-create.php">Tạo cửa hàng</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="shop-read.php">DS cửa hàng</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="menu-create.php">Tạo món</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="menu-read.php">DS các món</a></li>
                        </ul>
                    </li>
